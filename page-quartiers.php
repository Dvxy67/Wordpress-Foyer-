    ...
    <style>
        ...
        * {
        ...
        .retour-section {
            ...
            align-items: center;
            justify-content: center;
            height: 118px;  /* ← MODIF : 70px → 118px */
            flex-shrink: 0;
            width: 100%;  /* ← AJOUT : pour correspondre à logement */
        }
        ...
        .arrow {
            width: 90px;  /* ← MODIF : 80px → 90px */
            height: 90px;  /* ← MODIF : 80px → 90px */
            display: flex;
            align-items: center;
            justify-content: center;
            flex-shrink: 0;
        ...
        @media (min-width: 481px) {
            ...
            .main-container {
                height: calc(100vh - 40px);  /* ← AJOUT : comme logement */
            }
            
            .quartiers-container {
                max-width: 400px;  /* ← MODIF : 380px → 400px */
                min-height: 560px;  /* ← AJOUT : comme logement */
                max-height: 660px;  /* ← AJOUT : comme logement */
