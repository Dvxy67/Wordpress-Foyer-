...
// ============================================
// PERSONNALISATION DES PAGES TEXTE
// ============================================

function foyer_customize_page_texte($wp_customize) {
    
    // Section pour configurer les pages texte
    $wp_customize->add_section('texte_page_settings', array(
        'title' => __('Page Texte - Configuration', 'foyer-theme'),
        'description' => __('Personnalisez l\'apparence de vos pages texte', 'foyer-theme'),
        'priority' => 35,
    ));
    
    // Titre personnalisé (optionnel - si vide, utilise le titre de la page)
    $wp_customize->add_setting('texte_title', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control('texte_title', array(
        'label' => __('Titre personnalisé', 'foyer-theme'),
        'section' => 'texte_page_settings',
        'type' => 'text',
        'description' => __('Laissez vide pour utiliser le titre de la page', 'foyer-theme'),
    ));
    
    // URL de retour (bouton X)
    $wp_customize->add_setting('texte_close_url', array(
        'default' => home_url(),
        'sanitize_callback' => 'esc_url_raw',
        'transport' => 'refresh',
    ...
    $wp_customize->add_control('texte_close_url', array(
        'label' => __('URL du bouton retour (X)', 'foyer-theme'),
        'section' => 'texte_page_settings',
        'type' => 'url',
        'description' => __('Où rediriger quand on clique sur le X (par défaut: accueil)', 'foyer-theme'),
    ));
}
add_action('customize_register', 'foyer_customize_page_texte');